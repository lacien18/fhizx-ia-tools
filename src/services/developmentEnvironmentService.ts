...
const DEVELOPMENT_STYLE_SETTINGS: Readonly<Record<string, unknown>> = {
  ...
  "cSpell.userWords": [
    ...
    "riverpod",
    "screenutil",
    "seccionbanneracumulamas",
    "seccionbannerprincipal",
    "seccioncarruselaliados",
    "secciongeolocalización",
    "seccionserviciospuntospay",
    "seccionsponsoredbanner",
    "secciontiendaonline",
    "seccionviajesvuelos",
    "Secundario",
    "sessionopciones",
  ...
  "pco-vscode-workbench.aiFocusMode.endsAt": "",
  "pco-vscode-workbench.openSpec.organization": "DevOpsPCO",
  "pco-vscode-workbench.workflow.profiles": [
    {
      name: "Página Web",
      organization: "DevOpsPCO",
      project: "Repositorio Página web",
      repoId: "pco-web-specs",
      specsPath: "docs/specs",
      reqsPath: "requirements",
      huAdoProject: "Portafolio Usuarios",
      huAdoTeam: "Conexion Integral",
    },
    {
      name: "App",
      organization: "DevOpsPCO",
      project: "Repositorio App",
      repoId: "pco-app-specs",
      specsPath: "docs/specs",
      reqsPath: "requirements",
      huAdoProject: "Portafolio Usuarios",
      huAdoTeam: "App",
    },
    {
      name: "Ecommerce",
      organization: "DevOpsPCO",
      project: "Repositorio Marketplace",
      repoId: "pco-mkp-specs",
      specsPath: "docs/specs",
      reqsPath: "requirements",
      huAdoProject: "Portafolio Ecommerce",
      huAdoTeam: "Marketplace",
    },
  ],
  "pco-vscode-workbench.workflow.activeProfile": "App",
  "chat.viewSessions.orientation": "stacked",
  "fhizxAiTools.cloud.owner": "lacien18",
  "fhizxAiTools.cloud.repo": "fhizx-ai-tools-backup",
  "fhizxAiTools.cloud.autoSync": true,
  "pco-vscode-workbench.openSpec.reqsPath": "requirements",
  "pco-vscode-workbench.openSpec.project": "Repositorio App",
  "pco-vscode-workbench.openSpec.repoId": "pco-app-specs",
  "pco-vscode-workbench.openSpec.huAdoProject": "Portafolio Usuarios",
  "pco-vscode-workbench.openSpec.huAdoTeam": "App",
